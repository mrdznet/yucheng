...
<!-- content -->
	<div class="login-wrap">
		<div class="login-main">
			...
			<div class="login-item">
				<div class="register-pact"><input type="checkbox" v-model="registerCheck" @click="updateCheck" checked="checked" value="" />我已阅读并同意<a href="#">《牛牛汇用户注册协议》</a></div>
			</div>
		</div>
	</div>
		...
		methods:{
			login:function() {
				...
				_this.$http.post(_this.apiUrl,{
					mobile:_this.mobile,valicode:_this.valicode,redirectUri:_this.redirectUri,checkcode:_this.checkcode,recommendid:_this.recommendid
