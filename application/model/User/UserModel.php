            ...
            try {
                ...
                if(empty($checkCus['id'])) {
                    ...
                    if(!empty($param['recommendrole']) || !empty($param['recommendid'])) {
                        ...
                        if($result["code"] == "200") {
                            $temp = ["code" => "305", "data"=>"/index/index/bindMobile?customerid=".$result['data']['customerid']];
                            // return ["code" => "305", "data"=>"/index/index/bindMobile?customerid=".$result['data']['customerid']];
                        } else {
                    ...
                    // if(!empty($param['recommendrole']) || !empty($param['recommendid'])) {
                    //     $result = $this->addUser(["mobile"=>$param['mobile'],"recommendrole"=>$param['recommendrole'],"recommendid"=>$param['recommendid']]);
                    // } else {
                    //     return ["code" => "404"];
                    // }
                } else {
                    ...
                    if($checkCus['enable'] == 0) {
                        // return ["code" => "305", "data" => "/index/index/bindMobile?customerid=".$checkCus['id']];
